...
def save_models(step, gen_model_AtoB, gen_model_BtoA):
    ...
    filename1 = 'gen_model_ColortoEdge_%06d.h5' % (step+1)
    gen_model_AtoB.save(directory1 + filename1)

    # Save the second generator model
    directory2 = './saved_models/'
    filename2 = 'gen_model_EdgetoColor_%06d.h5' % (step+1)
    gen_model_BtoA.save(directory2 + filename2)
